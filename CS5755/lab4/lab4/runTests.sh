...
for i in {1..5}; do
    ...
    output_file="matmul_1024_128.csv"
    ...
    raw_time=$(/usr/bin/time -f "%e" sh -c "python3 /classes/ece5755/pmu-tools/toplev.py --core S0-C0,S0-C1,S0-C2,S0-C3,S0-C4,S0-C5,S0-C6,S0-C7 -l1 -v --no-desc --force-cpu spr ./proflab4 -x, -o $temp_file" 2>&1 | awk '/^[0-9]/ {print $1}')    
