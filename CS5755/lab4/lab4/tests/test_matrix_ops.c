...
void test_matmul_3x1_by_1x3(void)
{
    ...
    // Run function under test
    float **C = matmul_multithread(A, B, 3, 1, 1, 3);
...
void test_matmul_512x512(void)
{
    ...
    srand(time(NULL));
    //just change this instead of making new test
    int A_rows = 1024, A_cols = 128, B_rows = 128, B_cols = 1024;
    ...
    for (int i = 0; i < 10; i++)
    {
        C = matmul_(A, B, A_rows, A_cols, B_rows, B_cols);
    }
    // Cleanup
    ...
    // for (int i = 0; i < 10; i++)
    // {
    //     C = matmul_multithread(A, B, 512, 512, 512, 512);
...
void test_matmul_1024x1024(void)
{
    ...
    for (int i = 0; i < 10; i++)
    {
        C = matmul(A, B, 1024, 1024, 1024, 1024);
