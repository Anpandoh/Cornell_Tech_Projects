...
for i in {1..5}; do
    ...
    output_file="1024_blocking_jik_16.csv"
    ...
    raw_time=$(/usr/bin/time -f "%e" sh -c "python3 /classes/ece5755/pmu-tools/toplev.py --core S0-C0 -l1 -v --no-desc --force-cpu spr ./proflab2 -x, -o $temp_file" 2>&1 | awk '/^[0-9]/ {print $1}')
